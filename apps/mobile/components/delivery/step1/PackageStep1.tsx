...
const styles = StyleSheet.create({
  wrap: { gap: R.space.xs, paddingTop: 2 },
  title: { fontFamily: R.font.display, fontSize: 16.5, color: S.textPrim },
  subtitle: { fontFamily: R.font.body, fontSize: 12.5, color: S.textMuted, marginTop: 1 },
});
