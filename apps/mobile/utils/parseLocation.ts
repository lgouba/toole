...
/**
 * Indique si une URL courte (goo.gl, maps.app.goo.gl) doit être resolue.
 * Les liens courts nécessitent une resolution réseau - retourne true pour afficher un message.
 */
